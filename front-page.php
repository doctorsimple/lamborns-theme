    ...
    <div class="content">
        ...
        <?php
            ...
            if( isset( $wp_customize ) ){
                $items = true;
                $items_class = !($are_active_sidebras || (bool)get_theme_mod( 'default-content', true ) ) ? 'hidden' : '';
            }

            /* FRONTEND */
            else{
                $items = $are_active_sidebras || (bool)get_theme_mod( 'default-content', true );
            }
        ...
        ?>
                ...
                <!-- FEATURES -->
                <aside class="row mythemes-header-items mythemes-default-content <?php echo esc_attr( $items_class ); ?>">
        ...
        <div class="row">
            ...
            ?>
                    ...
                    <?php
                        ...
                        /* NOT FOUND RESULT */
                        if( $not_found ){
                            echo '<h3>' . __( 'Not found the page to be displayed in the front page' , 'treeson' ) . '</h3>';
                            echo '<p>' . __( 'We apologize but this page does not exist or can not be found. Perhaps it is necessary to change the call method to this page.' , 'treeson' ) . '</p>';
                        }
